...
**Unity Catalog:** managed separately via [terraform/databricks_unity_catalog](../databricks_unity_catalog/) or in Databricks Account Console. This workspace workflow now provisions workspace resources only.
