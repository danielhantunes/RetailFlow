...
# MAGIC %md
# MAGIC # Bronze: Geolocation
# MAGIC - Read RAW JSONL from ADLS (`postgres_ingest/geolocation` by default).
...
raw_rel = spark.conf.get("retailflow.raw_geolocation_rel_path", "postgres_ingest/geolocation")
