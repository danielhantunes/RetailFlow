...
# MAGIC %md
# MAGIC # Bronze: Sellers
# MAGIC - Read RAW JSONL from ADLS (`postgres_ingest/sellers` by default).
...
raw_rel = spark.conf.get("retailflow.raw_sellers_rel_path", "postgres_ingest/sellers")
